...
* Changed: Added grouped `.github/dependabot.yml` config (npm/composer/github-actions) to consolidate future dependency update PRs.

= 2.1.2 =
* Changed: Renamed "Folder Settings" menu to "VMF Settings" for consistency.
* Changed: Moved VMF Settings menu to bottom of Media submenu.
